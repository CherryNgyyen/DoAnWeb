...
namespace DoAn_QuanLyDiemSinhVien.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSV,HoTen,NgaySinh,Email,Lop,Hinh,DiemTB")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSV,HoTen,NgaySinh,Email,Lop,Hinh,DiemTB")] SinhVien sinhVien)
        {
            if (ModelState.IsValid)
            {
